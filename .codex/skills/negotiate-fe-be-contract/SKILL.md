...
- 메인 에이전트는 BE 구현 편의가 아니라 요구사항, FE 구현 가능성, 보안, 테스트 가능성, 사용자 승인 상태를 기준으로 중재한다.
...
- BE 아키텍처/이슈 산출물: `docs/architecture/*`, `docs/features/*/issues/*/issue.md`
...
- FE 산출물/구현 근거: FE repo의 `docs`, `src`, `package.json`
...
3. 요구사항, FE repo, BE repo를 읽어 협의 후보를 도출하거나 갱신한다.
...
- 구현 순서와 기존 PRD/TRD/architecture와의 충돌

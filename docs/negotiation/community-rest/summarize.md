# Community REST Contract Summary

## 상태

- status: fixed
- source_artifacts: `docs/negotiation/community-rest/20260714-163042.md`, `docs/negotiation/community-rest/20260714-163121.md`, `docs/negotiation/community-rest/20260714-163346.md`, `docs/negotiation/community-rest/20260714-163507.md`, `docs/negotiation/community-rest/20260714-170021.md`, `docs/negotiation/community-rest/20260714-170217.md`, `docs/negotiation/community-rest/20260714-170251.md`, `docs/negotiation/community-rest/20260714-170424.md`
- supersedes: 없음
...
- 사용자 결정: title 100, body 1,000, trimmed q 100 code point; list title 1줄/body 3줄 FE ellipsis, detail 전체 표시.
- 사용자 결정: MVP page 20 latest keyset, masked title/body/current author display의 case-insensitive substring search, category 없음.
- 사용자 결정: hidden/deleted/unknown/non-owner는 동일 HTTP 404 + RESOURCE_NOT_FOUND, restore는 original createdAt 위치.
- FE/BE 기술 재검토: full PUT masked/raw 훼손을 field-presence PATCH로 제거했다. 제품 정책 변경, 추가 사용자 결정과 architecture 변경 없음.
- FE/BE 최종 확인: fixed 가능.

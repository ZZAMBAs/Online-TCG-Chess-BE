# Identity Account REST Contract Summary

## 상태

- status: fixed
- source_artifacts: `docs/negotiation/identity-account-rest/20260714-160835.md`, `docs/negotiation/identity-account-rest/20260714-160907.md`, `docs/negotiation/identity-account-rest/20260714-161132.md`, `docs/negotiation/identity-account-rest/20260714-161218.md`, `docs/negotiation/identity-account-rest/20260714-161337.md`, `docs/negotiation/identity-account-rest/20260714-161411.md`
- supersedes: 없음
...
- 사용자 결정: 선택 알림을 꺼도 기존 inbox와 업무 원본은 유지하고 이후 선택 inbox 항목만 만들지 않는다. 제재와 중요 공지는 필수로 생성한다.
- 사용자 결정: MVP inbox는 읽음·삭제·자동 만료 없이 계속 보관한다.
- 사용자 결정: admin REST/UI가 NORMAL/IMPORTANT announcement를 발행하며 NORMAL은 optional, IMPORTANT는 required inbox를 생성한다.
- FE/BE 최종 확인: fixed 가능, 추가 사용자 결정과 아키텍처 변경 없음.

# Match Chat Contract Summary

## 상태

- status: fixed
- source_artifacts: `docs/negotiation/match-chat-contract/20260714-161850.md`, `docs/negotiation/match-chat-contract/20260714-162040.md`, `docs/negotiation/match-chat-contract/20260714-162230.md`, `docs/negotiation/match-chat-contract/20260714-162346.md`, `docs/negotiation/match-chat-contract/20260714-162436.md`, `docs/negotiation/match-chat-contract/20260714-162607.md`, `docs/negotiation/match-chat-contract/20260714-162643.md`
- supersedes: 없음
...
- 사용자 결정: current-game latest 50 + older 50 cursor history, visibility reactivation restore, terminated-game user history 제외.
- 사용자 결정: 기존 message는 전송 당시 `maskedText`를 유지하고 dictionary 변경을 소급하지 않는다.
- 사용자 결정: block 전 eligible message는 유지하고 block 중 ineligible message는 unblock 뒤에도 소급 노출하지 않는다.
